        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text("Register As a Shop",style: TextStyle(fontSize: 24,color: kPrimaryColor,fontWeight: FontWeight.bold))
              ),
              SizedBox(height: height*0.05,),
              const FieldLabel(text: "Shopname"),
              TextFieldForm(hintText: 'Shopname', textEditingController: shopnameController,isObscure: false,textFieldType: 'Shopname',),
